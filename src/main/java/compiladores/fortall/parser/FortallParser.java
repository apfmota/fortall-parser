...
public class FortallParser extends Parser {
	...
	public static final int
		...
		RULE_comando = 9, RULE_escrita = 10, RULE_valores_string = 11, RULE_valor_string = 12, 
		RULE_mais_valores_string = 13, RULE_leitura = 14, RULE_atribuicao = 15, 
		RULE_se = 16, RULE_senao = 17, RULE_loop = 18, RULE_expressao = 19, RULE_expressao_aritmetica = 20, 
		RULE_expressao_logica = 21, RULE_relacao = 22, RULE_aritmetica = 23, RULE_termo = 24, 
		RULE_precedente = 25, RULE_fator = 26, RULE_sinalizador = 27, RULE_valor = 28;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"valor_string", "mais_valores_string", "leitura", "atribuicao", "se", 
			"senao", "loop", "expressao", "expressao_aritmetica", "expressao_logica", 
			"relacao", "aritmetica", "termo", "precedente", "fator", "sinalizador", 
			"valor"
		};
	}
	...
	public static class Valores_stringContext extends ParserRuleContext {
		public Valor_stringContext valor_string() {
			return getRuleContext(Valor_stringContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Valor_stringContext extends ParserRuleContext {
		public TerminalNode STRING() { return getToken(FortallParser.STRING, 0); }
		public ExpressaoContext expressao() {
			return getRuleContext(ExpressaoContext.class,0);
		}
		public Valor_stringContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_valor_string; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FortallListener ) ((FortallListener)listener).enterValor_string(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FortallListener ) ((FortallListener)listener).exitValor_string(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FortallVisitor ) return ((FortallVisitor<? extends T>)visitor).visitValor_string(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Valor_stringContext valor_string() throws RecognitionException {
		Valor_stringContext _localctx = new Valor_stringContext(_ctx, getState());
		enterRule(_localctx, 24, RULE_valor_string);
		try {
			setState(116);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Mais_valores_stringContext mais_valores_string() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_mais_valores_string);
		try {
			setState(121);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final SenaoContext senao() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_senao);
		try {
			setState(144);
			_errHandler.sync(this);
	...
	public static class Expressao_aritmeticaContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FortallListener ) ((FortallListener)listener).enterExpressao_aritmetica(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FortallListener ) ((FortallListener)listener).exitExpressao_aritmetica(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FortallVisitor ) return ((FortallVisitor<? extends T>)visitor).visitExpressao_aritmetica(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Expressao_aritmeticaContext expressao_aritmetica() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_expressao_aritmetica);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(156);
	...
	public final Expressao_logicaContext expressao_logica() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_expressao_logica);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(159);
	...
	public final RelacaoContext relacao() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_relacao);
		try {
			setState(175);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final AritmeticaContext aritmetica() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_aritmetica);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(177);
	...
	public final PrecedenteContext precedente() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_precedente);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(191);
	...
	public final SinalizadorContext sinalizador() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_sinalizador);
		try {
			setState(208);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
